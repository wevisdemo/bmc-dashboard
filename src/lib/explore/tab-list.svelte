...
<div class="-mx-3 bg-neutral-300 md:m-0" bind:this={container}>
	<Tabs.Root bind:value={tab} onValueChange={ontabchange}>
		...
		>
			<li>
				ส.ก. จะตั้งกระทู้ถาม เมื่อต้องการ <strong>ผลักดัน</strong> หรือ
		...
		>
			<li>
				ส.ก. จะตั้งญัตติ เมื่อต้องการเสนอประเด็นหนึ่ง ๆ เข้าสู่สภา โดยทั่วไปญัตติจะเกี่ยวกับ<strong
		...
		>
			<li>
				เปรียบเสมือน<strong>กฎหมาย</strong>ที่บังคับใช้ทั่วทั้ง กทม. ซึ่ง ส.ก.
		...
		>
			<li>
				สก. นั่งในคณะกรรมการวิสามัญพิจารณาร่างงบประมาณประจำปี เพื่อพิจารณางบฯ
